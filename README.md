<picture>
  ...
  <img src="assets/hero.light.svg" alt="Rock — Reliability &amp; systems engineer · full-stack builder. 16 repositories, 7.9K commits, 855K lines of source, 6 apps in production, 1 engineer." width="100%">
</picture>
...
<sub>Portfolio snapshot dated Sep 7, 2026. These figures are computed from the git history and tracked source tree; the visible date prevents an old snapshot from presenting as live telemetry.</sub>

<picture>
  <source media="(prefers-color-scheme: dark)" srcset="assets/commits.dark.svg">
  <img src="assets/commits.light.svg" alt="Commits per repository — ParentPod 2,605; Longevity 1,102; RealInvestorX 1,099; Apex 871; Compliance OS 751; TheLoop 641; Beyond Volatility 582; EngiByte 126; JaLingo 103; Bid Spotter 45. ~7.9K total, single author." width="100%">
</picture>

<picture>
  <source media="(prefers-color-scheme: dark)" srcset="assets/languages.dark.svg">
  <img src="assets/languages.light.svg" alt="Language mix across 855K lines of tracked source — TypeScript 66.0%, JavaScript 25.0%, CSS 4.4%, SQL 1.7%, PHP 1.4%, Python 1.1%, Other 0.4%." width="100%">
</picture>
...
<picture>
  ...
  <img src="assets/velocity.light.svg" alt="Shipping cadence over the trailing 90 days — ParentPod 440 commits; Longevity 378 commits; Compliance OS 213 commits; RealInvestorX 195 commits; EngiByte 124 commits; TheLoop 104 commits; JaLingo 103 commits; Apex 99 commits; Bid Spotter 32 commits." width="100%">
</picture>

<sub>Still shipping — latest version and commit volume over the last 90 days, as of Sep 7, 2026. Regenerated from git, not hand-edited.</sub>

| Product | Latest | Commits · 90d |
|---|---|---|
| **ParentPod** | `v2.62.428` | 440 |
| **Longevity** | `v2.0.103` | 378 |
| **Compliance OS** | `v3.17.0` | 213 |
| **RealInvestorX** | `v5.20.34` | 195 |
| **EngiByte** | `v1.3.1` | 124 |
| **TheLoop** | `v1.2.0` | 104 |
| **JaLingo** | `v0.5.0` | 103 |
| **Apex** | `v0.2.6` | 99 |
| **Bid Spotter** | `v2.1.0` | 32 |
